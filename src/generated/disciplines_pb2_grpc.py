...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in disciplines_pb2_grpc.py depends on'
...
class DisciplineServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetInfo = channel.unary_unary(
                ...
                response_deserializer=data__pb2.DisciplineProperties.FromString,
                _registered_method=True)
        self.SetStreamOptions = channel.unary_unary(
                '/philote.DisciplineService/SetStreamOptions',
                request_serializer=data__pb2.StreamOptions.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.GetAvailableOptions = channel.unary_unary(
                '/philote.DisciplineService/GetAvailableOptions',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=data__pb2.OptionsList.FromString,
                _registered_method=True)
        self.SetOptions = channel.unary_unary(
                '/philote.DisciplineService/SetOptions',
                request_serializer=data__pb2.DisciplineOptions.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.Setup = channel.unary_unary(
                ...
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.GetVariableDefinitions = channel.unary_stream(
                '/philote.DisciplineService/GetVariableDefinitions',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=data__pb2.VariableMetaData.FromString,
                _registered_method=True)
        self.GetPartialDefinitions = channel.unary_stream(
                '/philote.DisciplineService/GetPartialDefinitions',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=data__pb2.PartialsMetaData.FromString,
                _registered_method=True)
...
def add_DisciplineServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=data__pb2.DisciplineProperties.SerializeToString,
            ),
            'SetStreamOptions': grpc.unary_unary_rpc_method_handler(
                    servicer.SetStreamOptions,
                    request_deserializer=data__pb2.StreamOptions.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'GetAvailableOptions': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAvailableOptions,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=data__pb2.OptionsList.SerializeToString,
            ),
            'SetOptions': grpc.unary_unary_rpc_method_handler(
                    servicer.SetOptions,
                    request_deserializer=data__pb2.DisciplineOptions.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            ...
            'GetVariableDefinitions': grpc.unary_stream_rpc_method_handler(
                    servicer.GetVariableDefinitions,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=data__pb2.VariableMetaData.SerializeToString,
            ),
            'GetPartialDefinitions': grpc.unary_stream_rpc_method_handler(
                    servicer.GetPartialDefinitions,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=data__pb2.PartialsMetaData.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'philote.DisciplineService', rpc_method_handlers)
...
class DisciplineService(object):
    ...
    def GetInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            data__pb2.DisciplineProperties.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SetStreamOptions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/philote.DisciplineService/SetStreamOptions',
            data__pb2.StreamOptions.SerializeToString,
    ...
    @staticmethod
    def GetAvailableOptions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/philote.DisciplineService/GetAvailableOptions',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            data__pb2.OptionsList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SetOptions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/philote.DisciplineService/SetOptions',
            data__pb2.DisciplineOptions.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    @staticmethod
    def GetVariableDefinitions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def GetPartialDefinitions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/philote.DisciplineService/GetPartialDefinitions',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            data__pb2.PartialsMetaData.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class ExplicitServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.ComputeFunction = channel.stream_stream(
                '/philote.ExplicitService/ComputeFunction',
                request_serializer=data__pb2.Array.SerializeToString,
                response_deserializer=data__pb2.Array.FromString,
                _registered_method=True)
        self.ComputeGradient = channel.stream_stream(
...
def add_ExplicitServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ComputeFunction': grpc.stream_stream_rpc_method_handler(
                    servicer.ComputeFunction,
                    request_deserializer=data__pb2.Array.FromString,
                    response_serializer=data__pb2.Array.SerializeToString,
            ),
            'ComputeGradient': grpc.stream_stream_rpc_method_handler(
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'philote.ExplicitService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ExplicitService(object):
    ...
    @staticmethod
    def ComputeFunction(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/philote.ExplicitService/ComputeFunction',
            data__pb2.Array.SerializeToString,
            data__pb2.Array.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def ComputeGradient(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
...
class ImplicitServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.ComputeResiduals = channel.stream_stream(
                '/philote.ImplicitService/ComputeResiduals',
                request_serializer=data__pb2.Array.SerializeToString,
                response_deserializer=data__pb2.Array.FromString,
                _registered_method=True)
        self.SolveResiduals = channel.stream_stream(
                '/philote.ImplicitService/SolveResiduals',
                request_serializer=data__pb2.Array.SerializeToString,
                response_deserializer=data__pb2.Array.FromString,
                _registered_method=True)
        self.ComputeResidualGradients = channel.stream_stream(
...
def add_ImplicitServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ComputeResiduals': grpc.stream_stream_rpc_method_handler(
                    servicer.ComputeResiduals,
                    request_deserializer=data__pb2.Array.FromString,
                    response_serializer=data__pb2.Array.SerializeToString,
            ),
            'SolveResiduals': grpc.stream_stream_rpc_method_handler(
                    servicer.SolveResiduals,
                    request_deserializer=data__pb2.Array.FromString,
                    response_serializer=data__pb2.Array.SerializeToString,
            ),
            'ComputeResidualGradients': grpc.stream_stream_rpc_method_handler(
                    servicer.ComputeResidualGradients,
                    request_deserializer=data__pb2.Array.FromString,
                    response_serializer=data__pb2.Array.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'philote.ImplicitService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ImplicitService(object):
    ...
    @staticmethod
    def ComputeResiduals(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def SolveResiduals(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ComputeResidualGradients(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
